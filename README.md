...
Esse é o projeto mais desafiador até agora! Fui responsável por criar uma aplicação de ponta a ponta!

Isso significa que a API, o banco de dados e o front-end foram escritos por mim e meu grupo. 😁

O projeto em si é super divertido! Foi criado uma plataforma de delivery de cerveja. 🍻
...
- A aplicação deve ter um admin padrão com o nome de usuário `tryber` e senha `123456`.

- A aplicação deve ter, no mínimo, os produtos abaixo cadastrados. O arquivo `images.tar.gz`, na raiz do projeto, contém imagens para estes produtos.
...
##### O projeto é composto por duas entregas, cada uma especificada abaixo com seus respectivos requisitos e o prazo decidido com a facilitação.
